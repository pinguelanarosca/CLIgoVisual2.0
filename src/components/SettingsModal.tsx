...
import { ChatMessage, ProjectItem, AuthorizedDir, SessionItem } from '../types.js';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  }, [isOpen, isModelSelectorOpen, onClose]);
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-48 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50/60 dark:bg-zinc-900/40 p-1.5 space-y-0.5 overflow-y-auto shrink-0">
            {[
              ...
              { id: 'backup_reset', label: 'Backup & Reset', icon: Database },
          ...
          {/* Tab Content Area — Compact p-3 */}
          <div className="flex-1 overflow-y-auto p-3 bg-white dark:bg-zinc-900">
            {/* 1. GEMINI CLI */}
            {activeTab === 'cli' && (
              <CliSettingsSection
                cliStatus={cliStatus}
            ...
            {/* BACKUP, RESTAURAÇÃO E RESET DE FÁBRICA */}
            {activeTab === 'backup_reset' && (
              <BackupAndResetSection onRefreshGlobalStatus={onRefreshStatus} />
            )}
